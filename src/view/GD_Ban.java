...
public class GD_Ban extends javax.swing.JPanel {
    ...
    private void myButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButton2ActionPerformed
        ...
        ListBan.add(new BanItem("200","/image/empty_table.png",main));
        ListBan.add(new BanItem("150","/image/order_table.png",main));
        ListBan.add(new BanItem("120","/image/pre_order_table.png",main));
        ListBan.repaint();
        ListBan.revalidate();
